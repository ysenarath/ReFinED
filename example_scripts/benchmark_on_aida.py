...
refined = Refined.from_pretrained(
    model_name="aida_model", entity_set="wikipedia", use_precomputed_descriptions=True
)
...
refined.process_text_batch(
    texts=texts, prune_ner_types=False, return_special_spans=False, max_batch_size=8
)
end_time = time.time()
